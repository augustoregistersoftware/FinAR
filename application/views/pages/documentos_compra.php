    ...
    <div class="table-responsive">
        <table class="row-border" id="documentos">
            ...
            <tbody>
                ...
                <tr>
                    <th><?= $documentos['id_documento_comp']?></th>
                    <td><?= $documentos['descricao']?></td>
                    <td> 
                        <a title="Abrir Documento" href="javascript:goAbrir(<?= $documentos['id_documento_comp']?>)" class="btn btn-info btn-sm btn-info"><i class="fa-solid fa-folder-open"></i></a>
                        <a title="Deletar Documento" href="javascript:goDelete(<?= $documentos['id_documento_comp']?>)" class="btn btn-danger btn-sm btn-danger"><i class="fa-solid fa-xmark"></i></a>
                </tr>
                <?php endforeach;?>
            </tbody>
        </table>
