        ...
        <div class="btn-toolbar mb-2 mb-md-0">
          <div class="btn-group mr-2">
			...
			<?php if(isset($empresa_editar)) : ?>
					...
					<form action="<?= base_url() ?>produto/update/<?= $empresa_editar['id_empresa'] ?>" method="post">
				<?php else : ?>
                ...
                <div class="col-md-6">
						<div class="form-group">
							...
							<input type="number" class="form-control" name="cod_barra" id="cod_barra" placeholder="Código De Barras">
						</div>
				</div>    
                ...
                <div class="col-md-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" name="cod_aux" id="cod_aux" placeholder="Código Auxiliar" required>
						</div>
				</div>
                ...
                <div class="col-md-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" name="custo" id="custo" placeholder="R$ Custo">
						</div>
				</div>
                ...
                <div class="col-md-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" name="preco_venda" id="preco_venda" placeholder="R$ Preço De Venda" required>
						</div>
				</div>
                ...
                <div class="col-md-6">
						<div class="form-group">
							...
							<input type="number" class="form-control" name="estoque_atual" id="estoque_atual" placeholder="Estoque Atual" required>
						</div>
				</div>
                ...
                <div class="col-md-6">
						<div class="form-group">
							...
							<input type="number" class="form-control" name="estoque_minimo" id="estoque_minimo" placeholder="Estoque Minimo" required>
						</div>
				</div>
